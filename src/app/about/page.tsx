...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      <h1 className="text-4xl font-bold text-gray-900 dark:text-white">About Vibe OpenClaw</h1>

      <div className="mt-8 space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed">
        <p>
          <strong>Vibe OpenClaw</strong> is an independent resource hub for the
